...
const dumplingText = ["You explored potstickers(锅贴), a dumpling style that originated in a province in Northern China during the Song dynasty, known for its crispy underside.  According to legend, they were invented by an Imperial chef who accidentally burnt a batch of dumplings after leaving them on the stove for too long! ", "You explored wontons(混沌), a dumpling style popularized in Hong Kong after World War II, known for its translucent flour wrapping.   In Cantonese, ‘wonton’ roughly translates to ‘clouds’ – as the wontons look like clouds floating in the soup.", "You explored buns(小笼包), a dumpling style that originated in a Shanghai suburb over 150 years ago, known for its fluffy wrapping and fragrant fillings. "];
